  ...
  return (
    <div className="p-10">
      <div className="flex flex-col items-center">
        <div className="py-16">
          <h1 className="text-2xl text-green-text font-bold text-center">Recommended Recipes</h1>
        </div>
        <div className="flex justify-between space-x-48">
          <div className="flex flex-col items-start p-4">
            <Image src="/pizza.jpg" alt="Recipe 2" width={287} height={200} />
            <h1 className="text-xl text-green-text font-semibold my-8">Pizza Margherita</h1>
          ...
          <div className="flex flex-col items-start p-4">
            <Image
              ...
              height={200}
            />
            <h1 className="text-xl text-green-text font-semibold my-8">General Tso's Chicken</h1>
            <p className="text-green-text w-72">
          ...
          <div className="flex flex-col items-start p-4">
            ...
            <h1 className="text-xl text-green-text font-semibold my-8">Caesar Salad</h1>
            <p className="text-green-text w-72">
